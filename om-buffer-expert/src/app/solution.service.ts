...
export class SolutionService {
  ...
  constructor(private http: HttpClient, private solutionMixtureService: SolutionMixtureService) {
  ...
  deleteSolution(solution: Solution) {
    ...
    // If the deleted solution was the current solution, update the current solution
